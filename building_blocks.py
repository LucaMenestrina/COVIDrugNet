...
def coloring_dropdown(prefix):
    ...
    return html.Div(
        [
            ...
            dbc.Tooltip(
                "Select Graph Coloring",
                target=prefix + "_coloring_dropdown_div",
                placement="top",
                hide_arrow=True,
                delay={"show": 500, "hide": 250},
            ),
...
def highlighting(prefix, nodes):
    return html.Div(
        [
            dcc.Dropdown(
                id=prefix + "_highlighter_dropdown",
                options=[
                ...
                multi=True,
                className="DropdownMenu",
            ),  # , style={"max-height":"15vh","overflow-y":"auto"} right now it is not possible to limit the overflow, otherwise it hides the selectable options
            dbc.Tooltip(
                "Highlight Specific Nodes for Easier Spotting",
                target=prefix + "_highlighter_dropdown_div",
                placement="top",
                hide_arrow=True,
                delay={"show": 500, "hide": 250},
            ),
            html.Div(
                id=prefix + "_highlighted_data_cache", style={"display": "none"}
            ),  # for temporary store highlighted nodes data
        ],
...
def group_highlighting(prefix, nodes):
                    ...
                    [
                        html.Strong(
                            html.P(
                                ...
                                id=prefix + "_group_property",
                            )
                        ),
                        dbc.Tooltip(
                            "Available Nodes' Properties for Highlighting",
                            target=prefix + "_group_property",
                            placement="top",
                            hide_arrow=True,
                            delay={"show": 500, "hide": 250},
                        ),
                    ...
                    [
                        html.Strong(
                            html.P(
                                "Filter",
                                style={"text-align": "center"},
                                id=prefix + "_group_filter",
                            )
                        ),
                        dbc.Tooltip(
                            "Chosen Filter for the Properties",
                            target=prefix + "_group_filter",
                            placement="top",
                            hide_arrow=True,
                            delay={"show": 500, "hide": 250},
                        ),
                    ...
                    [
                        html.Strong(
                            html.P(
                                "Logical Conjunction",
                                style={"text-align": "center"},
                                id=prefix + "_group_conjunction",
                            )
                        ),
                        dbc.Tooltip(
                            "Logical Operation for Joining Filters",
                            target=prefix + "_group_conjunction",
                            placement="top",
                            hide_arrow=True,
                            delay={"show": 500, "hide": 250},
                        ),
        ...
        for property in [
            ...
            modal_body.append(
                dbc.Row(
                    [
                        dbc.Col(
                            [html.Font(property, style={"text-align": "center"})],
                            width=2,
                            align="center",
                        ),
                        dbc.Col(
                            [
                                dcc.Dropdown(
                                    ...
                                    multi=True,
                                    className="DropdownMenu",
                                    id=prefix + "_highlight_dropdown_" + property,
                                )
                            ],
                            width=7,
                            align="center",
                        ...
                        dbc.Col(
                            [conjunction(prefix + "_conjunction_" + property)],
                            width=2,
                            align="center",
                        ),
                    ],
    ...
    if prefix in ["drug_projection", "target_projection"]:
        for property in properties:
            all_prop = sorted(
                set([prop for node in nodes for prop in node["data"][property]])
            )
            options = [
                {
                    "label": prop,
        ...
        modal_body += [  # it shouldn't have been hard coded # it is only to hide the label
            dbc.Row(
                [
                    ...
                    ),  # [html.Font("Kind", style={"text-align":"center"})]
                    dbc.Col(
                        [
                            dcc.Dropdown(
                                options=[
                                    {
                                        ...
                                        "value": ",".join(
                                            [
                                                node["data"]["ID"]
                                                for node in nodes
                                                if prop in node["data"]["kind"]
                                            ]
                                        ),
                                    }
                                    for prop in ["Drug", "Target"]
                                ],
                                multi=True,
                                className="DropdownMenu",
                                id=prefix + "_highlight_dropdown_kind",
                            )
                        ],
                        width=7,
                        align="center",
                    ...
                    dbc.Col(
                        [conjunction(prefix + "_conjunction_kind")],
                        width=2,
                        align="center",
                    ),
                ],
                    ...
                    [
                        html.Strong(
                            html.P(
                                "Centrality",
                                style={"text-align": "center"},
                                id=prefix + "_group_centrality",
                            )
                        ),
                        dbc.Tooltip(
                            "Available Nodes' Centralities for Highlighting",
                            target=prefix + "_group_centrality",
                            placement="top",
                            hide_arrow=True,
                            delay={"show": 500, "hide": 250},
                        ),
                    ...
                    [
                        html.Strong(
                            html.P(
                                "Equality Filter",
                                style={"text-align": "center"},
                                id=prefix + "_group_centrality_equality",
                            )
                        ),
                        dbc.Tooltip(
                            "Chosen Equality Filter for the Centrality",
                            target=prefix + "_group_centrality_equality",
                            placement="top",
                            hide_arrow=True,
                            delay={"show": 500, "hide": 250},
                        ),
                    ...
                    [
                        html.Strong(
                            html.P(
                                "Reference Value",
                                style={"text-align": "center"},
                                id=prefix + "_group_centrality_value",
                            )
                        ),
                        dbc.Tooltip(
                            "Reference Value for Filtering",
                            target=prefix + "_group_centrality_value",
                            placement="top",
                            hide_arrow=True,
                            delay={"show": 500, "hide": 250},
                        ),
    ...
    for centrality in [
        ...
        modal_body.append(
            dbc.Row(
                [
                    dbc.Col(
                        [html.Font(centrality, style={"text-align": "center"})],
                        width=3,
                        align="center",
                    ),
                    dbc.Col(
                        [equality(prefix + "_equality_" + centrality)],
                        width=6,
                        align="center",
                    ),
                    dbc.Col(
                        [
                            dcc.Dropdown(
                                ...
                                multi=False,
                                className="DropdownMenu",
                                id=prefix + "_highlight_value_" + centrality,
                            )
                        ],
                        width=3,
                        align="center",
    ...
    modal_body += [
        ...
        dbc.Row(
            [
                ...
                dbc.Col(
                    [conjunction(prefix + "_conjunction_general")],
                    width=2,
                    align="center",
                ),
            ],
        ...
        dbc.Row(
            [
                dbc.Col(
                    [
                        dbc.Checklist(
                            options=[{"label": "Only Major Component", "value": True}],
                            id=prefix + "_only_major_highlighted_groups",
        ...
        dbc.Row(
            [
                dbc.Col(
                    html.P("Highlighted nodes: ", style={"text-align": "right"}),
                    align="center",
                ),
                dbc.Col(
                    html.P(id=prefix + "_n_highlighted", style={"text-align": "left"}),
                    align="center",
                ),
            ],
            justify="center",
    ...
    return html.Div(
        [
            dbc.Button(
                ...
                id=prefix + "_group_highlighter_open",
                block=True,
                className="btn btn-outline-primary",
            ),
            dbc.Modal(
                    ...
                    dbc.ModalFooter(
                        [
                            html.A(
                                dbc.Button(
                                    "Download",
                                    id=prefix + "_download_group_highlighting_button",
                                    className="btn btn-outline-primary",
                                ),
                                download="highlighted_nodes.tsv",
                                id=prefix + "_download_group_highlighting_button_href",
                                target="_blank",
                            ),
                            dbc.Button(
                                "Clear",
                                id=prefix + "_group_highlighter_clear",
                                className="btn btn-outline-primary",
                            ),
                            dbc.Button(
                                "OK",
                                id=prefix + "_group_highlighter_close",
                                className="btn btn-outline-primary",
                            ),
                        ]
                    ),
                ...
                size="lg",
                id=prefix + "_group_highlighting_modal",
            ),
            dbc.Tooltip(
                "Highlight Nodes with Specific Properties",
                target=prefix + "_group_highlighter_open",
                placement="top",
                hide_arrow=True,
                delay={"show": 500, "hide": 250},
            ),
            html.Div(
                id=prefix + "_highlighted_cache", style={"display": "none"}
            ),  # for temporary store highlighted nodes
        ]
    )
        ...
        [
            dbc.Container(
                [
                            ...
                            dbc.Col(
                                dcc.Dropdown(
                                    options=[
                                        ...
                                        {
                                            "label": "Selected OR Highlighted ",
                                            "value": "selected_or_highlighted",
                                        },
                                        {
                                            "label": "Selected AND Highlighted ",
                                            "value": "selected_and_highlighted",
                                        },
                                    ],
                                    id=prefix + "_inspected_dropdown",
                                    value="selected_or_highlighted",
                                    multi=False,
                                    searchable=False,
                                    clearable=False,
                    ...
                    html.Br(),
                    dbc.Row(
                        dbc.Col(id=prefix + "_inspected_table", align="center"),
                        no_gutters=True,
                        justify="center",
                        align="center",
                    ),
            ...
            html.Div(
                id=prefix + "_inspected_cache", style={"display": "none"}
            ),  # for temporary store inspected data
        ],
...
def degree_distribution(graph, title):
    ...
    plot = go.Figure(
        layout={
            "title": {"text": "Degree Distribution", "x": 0.5, "xanchor": "center"},
            "xaxis": {"title_text": "Degree, k", "type": "log"},
            "yaxis": {
                "title_text": "Frequency of Nodes with degree k, n(k)",
                "type": "log",
            },
            "template": "ggplot2",
        }
    ...
    for deg, name, order, color, trendline_order in [
        (K, title, 1, "Tomato", "Linear")
    ]:  # ,(ERK,"Erdős-Rényi",2,"DeepSkyBlue","Quadratic")]:# Uncomment to show Equivalent Erdős-Rényi Graph
        x = list(get_frequency(deg.values()).keys())
        y = list(get_frequency(deg.values()).values())
        if (
            x[0] == 0
        ):  # to avoid problems with log10, they wouldn't be display anyway because of the loglog
            x = x[1:]
            y = y[1:]
        ...
        plot.add_trace(
            go.Scatter(x=x, y=y, mode="markers", name=name, marker_color=color)
        )
        # trendline
        ...
        plot.add_trace(
            go.Scatter(
                ...
                y=yfit(x),
                mode="lines",
                name=name + "'s " + trendline_order + " Trendline",
                line_color=color,
                visible="legendonly",
            )
        )
...
def plots(prefix, graph, title):
    ...
    children = [
        dbc.Col(
            [
                dbc.Spinner(
                    dbc.Container(dcc.Graph(id=prefix + "_piechart", responsive=True))
                )
            ],
            style={"padding": "0px"},
            xs=12,
        ...
        children += [
            dbc.Col(
                [
                    dbc.Spinner(
                        dcc.Graph(
                            figure=degree_distribution(graph, title),
                            id=prefix + "_degree_distribution",
                            responsive=True,
                        )
                    )
                ],
    ...
    return dbc.Container(
        [
            ...
            dbc.Row(
                children=children, justify="around", align="center", no_gutters=True
            ),
        ],
        id=prefix + "_plots",
        fluid=True,
...
def graph_properties(prefix):
    if prefix == "drug_target":
        options = [
            ...
            {
                "label": "Closeness Centrality: Low to High",
                "value": "Closeness Centrality,1",
            },
            {
                "label": "Closeness Centrality: High to Low",
                "value": "Closeness Centrality,0",
            },
            {
                "label": "Betweenness Centrality: Low to High",
                "value": "Betweenness Centrality,1",
            },
            {
                "label": "Betweenness Centrality: High to Low",
                "value": "Betweenness Centrality,0",
            },
            {
                "label": "Eigenvector Centrality: Low to High",
                "value": "Eigenvector Centrality,1",
            },
            {
                "label": "Eigenvector Centrality: High to Low",
                "value": "Eigenvector Centrality,0",
            },
        ...
        options = [
            ...
            {
                "label": "Clustering Coefficient: Low to High",
                "value": "Clustering Coefficient,1",
            },
            {
                "label": "Clustering Coefficient: High to Low",
                "value": "Clustering Coefficient,0",
            },
            {"label": "VoteRank Score: Low to High", "value": "VoteRank Score,1"},
            {"label": "VoteRank Score: High to Low", "value": "VoteRank Score,0"},
        ]
        ...
        [
            dbc.Col(
                [
                    ...
                    dbc.Row(
                        [
                            dbc.Col(
                                [
                                    dbc.Checklist(
                                        options=[{"label": "Inspected", "value": True}],
                                        id=prefix + "_only_inspected_properties",
                                        labelStyle={"white-space": "nowrap"},
                                        switch=True,
                                    ),
                                    dbc.Tooltip(
                                        [
                                            "Show only those nodes that are manually selected or highlighted in the Graph",
                                            html.Br(),
                                            "(If there are...)",
                                        ],
                                        target=prefix + "_only_inspected_properties",
                                        placement="top",
                                        hide_arrow=True,
                                        delay={"show": 500, "hide": 250},
                                    ),
                            ...
                            dbc.Col(
                                html.Font("Sort by: ", style={"white-space": "nowrap"}),
                                align="center",
                                style={"text-align": "right"},
                                xs=2,
                                lg=1,
                            ...
                            dbc.Col(
                                [
                                    dcc.Dropdown(
                                        id=prefix + "_properties_table_sorting",
                                        options=options,
                                        value="Degree,0",
                                        clearable=False,
                                        searchable=False,
                            ...
                            dbc.Col(
                                html.Font(
                                    "Rows to show: ", style={"white-space": "nowrap"}
                                ),
                                align="center",
                                style={"text-align": "right"},
                                xs=2,
                            ...
                            dbc.Col(
                                [
                                    dcc.Dropdown(
                                        id=prefix + "_properties_table_rows",
                                        options=[
                                            {"label": "10", "value": 10},
                                            {"label": "25", "value": 25},
                                            {"label": "50", "value": 50},
                            ...
                            dbc.Col(
                                html.A(
                                    ...
                                    target="_blank",
                                    download="graph_properties.tsv",
                                    id=prefix + "_download_graph_properties",
                                ),
                                align="center",
                            ),
                            dbc.Col(
                                html.A(
                                    ...
                                    id=prefix + "_graph_properties_glossary",
                                    href="/covidrugnet/help#help_glossary",
                                    target="_blank",
                                ),
                                align="center",
                    ...
                    dcc.Loading(
                        dbc.Container(
                            id=prefix + "_graph_properties_table_container", fluid=True
                        ),
                        type="dot",
                        color="grey",
                    ),
            ...
            dbc.Modal(
                [
                    ...
                    dbc.ModalBody(
                        [
                            dbc.Container(
                                id=prefix + "_custom_clusters_table_container",
                                fluid=True,
                            )
                        ]
                    ),
                    dbc.ModalFooter(
                        [
                            html.A(
                                ...
                                target="_blank",
                                download="custom_groups.tsv",
                                id=prefix + "_download_custom_clusters_modal",
                            ),
                            dbc.Button(
                                "Close",
                                id=prefix + "_view_clusters_close",
                                className="btn btn-outline-primary",
                            ),
                        ]
                    ),
                ],
                id=prefix + "_custom_clusters_modal",
                size="xl",
            ),
        ]
    )
...
def advanced_section(prefix, graph, graph_title):
    if "projection" in prefix:
        ...
        collapse = [custom_clustering(prefix), interactome(prefix)]
                    ...
                    dbc.Col(
                        [
                            dbc.Button(
                                ...
                                id=prefix + "_advanced_section_open",
                                color="link",
                                block=True,
                            ...
                            dbc.Tooltip(
                                "Open Section with Advanced Tools",
                                target=prefix + "_advanced_section_open",
                                placement="top",
                                hide_arrow=True,
                                delay={"show": 500, "hide": 250},
                            ),
...
def custom_clustering(prefix):
    return dbc.Container(
        [
                ...
                [
                    dbc.Col(
                        [
                            dbc.Spinner(
                                dcc.Graph(
                                    id=prefix + "_custom_clustering_graph",
                                    responsive=True,
                                )
                            )
                        ],
                        ...
                        xs=12,
                        md=6,
                        id=prefix + "_custom_clustering_graph_col",
                    ),  # I don't know why the dcc.Loading component moves the graph outside the column (covering the lower one)
                    dbc.Col(
                        [
                            dbc.Row(
                                [
                                    ...
                                    dbc.Col(
                                        dcc.Dropdown(
                                            id=prefix + "_custom_clustering_component",
                                            options=[
                                                {
                                                    "label": "Entire Graph",
                                                    "value": "entire",
                            ...
                            dbc.Row(
                                [
                                    ...
                                    dbc.Col(
                                        dcc.Dropdown(
                                            id=prefix + "_custom_clustering_method",
                                            options=[
                                                {
                                                    "label": "Spectral Clustering",
                                                    "value": "spectral_group",
                                                },
                                                {
                                                    "label": "Girvan Newman",
                                                    "value": "girvan_newman_group",
                                                },
                                                {
                                                    "label": "Greedy Modularity",
                                                    "value": "greedy_modularity_group",
                                                },
                                            ],
                                            value="spectral_group",
                                            clearable=False,
                            ...
                            dbc.Row(
                                [
                                    ...
                                    dbc.Col(
                                        dcc.Dropdown(
                                            id=prefix
                                            + "_custom_clustering_number_clusters",
                                            clearable=False,
                                            optionHeight=25,
                                            className="DropdownMenu",
                                        ),
            ...
            html.Br(),
            html.Div(
                id=prefix + "_clusters_cache", style={"display": "none"}
            ),  # for temporary store computed clusters
        ],
...
def adv_degree_distribution(prefix, graph, graph_title):
    ...
    return dbc.Container(
        [
            ...
            dbc.Row(
                [
                    dbc.Col(
                        html.Font(
                            graph_title + " xmin: ", style={"white-space": "nowrap"}
                        ),
                        align="center",
                        style={"text-align": "right"},
                        xs=3,
                    ...
                    dbc.Col(
                        html.Font(
                            "Erdős-Rényi xmin: ", style={"white-space": "nowrap"}
                        ),
                        align="center",
                        style={"text-align": "right"},
                        xs=3,
                ...
                [
                    dbc.Col(
                        [
                            dbc.Spinner(
                                dcc.Graph(
                                    id=prefix + "_adv_degree_distribution_plot",
                                    responsive=True,
                                    style={"height": "80vh"},
                                )
                            )
        ...
        id=prefix + "_adv_degree_distribution",
        fluid=True,
        style={"padding": "1%"},
    )
...
def interactome(prefix):
    G = nx.read_gpickle(
        "data/graphs/virus_host_interactome/virus_host_interactome.gpickle"
    )
    ...
    for node, node_data in G.nodes(data=True):
        if node_data["Viral"]:
            ...
            data["Human Proteins (Targeted by Drug)"]["labels"].append(
                node_data["Gene"]
            )
        else:
            data["Human Proteins (Not Targeted by Drug)"]["x"].append(
                node_data["pos"][0]
            )
            data["Human Proteins (Not Targeted by Drug)"]["y"].append(
                node_data["pos"][1]
            )
            data["Human Proteins (Not Targeted by Drug)"]["labels"].append(
                node_data["Gene"]
            )
    ...
    )  # for a transparent background but keeping modebar acceptable colors
    ...
    return dbc.Container(
        [
            ...
            dbc.Row(
                [
                    dbc.Button(
                        "Download",
                        id=prefix + "_save_interactome_open",
                        className="btn btn-outline-primary",
                    ),
                    dbc.Modal(
                        [
                            ...
                            dbc.ModalFooter(
                                [
                                    html.A(
                                        dbc.Button(
                                            "Download",
                                            id=prefix + "_download_interactome_button",
                                            className="btn btn-outline-primary",
                                        ),
                                        id=prefix + "_download_interactome_button_href",
                                        target="_blank",
                                    ),
                                    dbc.Button(
                                        "Close",
                                        id=prefix + "_save_interactome_close",
                                        className="btn btn-outline-primary",
                                    ),
                                ]
                            ),
                    ...
                    dbc.Tooltip(
                        "Download Virus-Host-Drug Interactome File",
                        target=prefix + "_save_interactome_open",
                        placement="top",
                        hide_arrow=True,
                        delay={"show": 500, "hide": 250},
                    ),
                    ...
                    dbc.Col(
                        [
                            dbc.Spinner(
                                dcc.Graph(
                                    figure=figure,
                                    id=prefix + "_virus_host_interactome_graph",
                                    responsive=True,
                                    style={"height": "80vh"},
                                    config={
                                        "scrollZoom": True,
        ...
        id=prefix + "_virus_host_interactome",
        fluid=True,
        style={"padding": "1%"},
    )
        ...
        [
            html.P(
                [
                    html.A(
                        html.Small("Write us"),
                        href="mailto:luca.menestrina2@unibo.it,chiara.cabrelle2@unibo.it,maurizio.recanatini@unibo.it?subject=contact%20from%20COVIDrugNet%20app",
                    ),
                    html.Small(" if you have any questions or suggestions"),
                    html.Br(),
                    html.Small(
                        "App developed by Luca Menestrina, Department of Pharmacy and Biotechnology, University of Bologna, Italy"
                    ),
                ],
                style={"margin": "0px"},
            )
