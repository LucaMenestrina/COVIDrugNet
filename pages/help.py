...
nodes_header = [
    html.Thead(
        html.Tr([html.Th("Property"), html.Th("Description"), html.Th("Source")])
    )
]
drugs_body = [
    html.Tbody(
        [
            html.Tr(
                [
                    ...
                    html.Td(
                        html.A(
                            "DrugBank", href="https://go.drugbank.com/", target="_blank"
                        )
                    ),
                ]
            ),
            html.Tr(
                [
                    html.Td("SMILES"),
                    html.Td(
                        "The chemical structure string notation for drugs. SMILES were recovered from PubChem if available, otherwise from Drugbank"
                    ),
                    html.Td(
                        [
                            html.A(
            ...
            html.Tr(
                [
                    ...
                    html.Td(
                        "The broad-based level of the ATC classification system identifying the fourteen anatomical/pharmacological groups"
                    ),
                    html.Td(
                        html.A(
                            "DrugBank", href="https://go.drugbank.com/", target="_blank"
            ...
            html.Tr(
                [
                    html.Td("Targets"),
                    html.Td(
                        "Entities to which the drug binds or interacts with, resulting in an alteration of their normal function and thus in desirable therapeutic effects or unwanted adverse effects"
                    ),
                    html.Td(
                        html.A(
                            "DrugBank", href="https://go.drugbank.com/", target="_blank"
            ...
            html.Tr(
                [
                    html.Td("Enzymes"),
                    html.Td(
                        "Proteins that facilitate a metabolic reaction that transforms the drug into one or more metabolites"
                    ),
                    html.Td(
                        html.A(
                            "DrugBank", href="https://go.drugbank.com/", target="_blank"
            ...
            html.Tr(
                [
                    html.Td("Carriers"),
                    html.Td(
                        "Proteins that bind to the drug and modify its pharmacokinetics, e.g., facilitating its transport in the blood stream or across cell membranes"
                    ),
                    html.Td(
                        html.A(
                            "DrugBank", href="https://go.drugbank.com/", target="_blank"
            ...
            html.Tr(
                [
                    ...
                    html.Td(
                        "Drugs that are known to interact, interfere or cause adverse reactions when taken with this drug"
                    ),
                    html.Td(
                        html.A(
                            "DrugBank", href="https://go.drugbank.com/", target="_blank"
        ...
        [
            ...
            html.Tr(
                [
                    html.Td("Drugs"),
                    html.Td(
                        "List of known drugs related with the protein (e.g., agonists, antagonists, inhibitors...)"
                    ),
                    html.Td(
                        html.A(
                            "DrugBank", href="https://go.drugbank.com/", target="_blank"
            ...
            html.Tr(
                [
                    ...
                    html.Td(
                        "Known and predicted protein-protein interactions (both physical and functional) only in Homo Sapiens and with a minimum score of 0.95"
                    ),
                    html.Td(
                        html.A("STRING", href="https://string-db.org/", target="_blank")
                    ),
                ]
            ),
            html.Tr(
                [
                    ...
                    html.Td(
                        [
                            "Disease groups with an Evidence Index of 1 (see ",
                            html.A(
                                "https://www.disgenet.org/dbinfo#section44",
                                href="https://www.disgenet.org/dbinfo#section44",
                                target="_blank",
                            ),
            ...
            html.Tr(
                [
                    html.Td("PDBID"),
                    html.Td(
                        "Protein Data Bank identification code (the structure with the best resolution)"
                    ),
                    html.Td(
                        html.A(
                            "SWISS-MODEL",
            ...
            html.Tr(
                [
                    ...
                    html.Td(
                        "The first and the second level of Protein Target Classification are named Protein Class and Protein Family respectively"
                    ),
                    html.Td(
                        html.A(
                            "ChEMBL",
...
graph_header = [html.Thead(html.Tr([html.Th("Property"), html.Th("Description")]))]
graph_body = [
    html.Tbody(
        [
            html.Tr([html.Td("Degree"), html.Td("Number of edges of a node")]),
            html.Tr(
                [
                    html.Td("Closeness Centrality"),
                    html.Td(
                        "How close a node is to other nodes along the shortest path"
                    ),
                ]
            ),
            html.Tr(
            ...
            html.Tr(
                [
                    ...
                    html.Td(
                        "Measure of the node importance taking into account the importance of its neighbors"
                    ),
                ]
            ),
            html.Tr(
                [
                    ...
                    html.Td(
                        "Measure of how close the neighbors of a node are to be fully connected"
                    ),
                ]
            ),
            html.Tr(
                        ...
                        dbc.Col(
                            [
                                ...
                                html.Center(
                                    [
                                        html.Img(
                                            src=app.get_asset_url("imgs/help.svg"),
                                            style={"width": "100%"},
                                            id=prefix + "_main",
                                        )
                                    ]
                                ...
                                html.Br(),
                                html.H4(
                                    "In the pages relative to the projections, there are some small differences:"
                                ),
                                html.Br(),
                                html.H5(
                                    "In the Charts and Plots Section the degree distribution is displayed",
                                    id=prefix + "_charts_and_plots",
                                ),
                                html.Center(
                                    [
                                        html.Img(
                                            src=app.get_asset_url(
                                                "imgs/help_charts&plots.svg"
                                            ),
                                            style={"width": "100%"},
                                        )
                                    ]
                                ...
                                html.Br(),
                                html.H5(
                                    "In the Advanced Tools Section the Degree Distribution can be inspected more thoroughly",
                                    id=prefix + "_advanced_degree_distribution",
                                ),
                                html.Center(
                                    [
                                        html.Img(
                                ...
                                html.P(
                                    [
                                        "All these properties are computed taking advantage of the Python package ",
                                        html.A(
                                            "NetworkX",
